...
async def get_agent_async():
    ...
    try:
        ...
        root_agent = LlmAgent(
            ...
            name='interactive_mcp_assistant',
            instruction='This server enables LLMs to interact with web pages through structured accessibility snapshots, bypassing the need for screenshots. Be helpful and concise.',
            tools=tools,
        )
